...
exports.MultiStreamRecorder = function(mediaStream) {
    if (!mediaStream) {
    ...
    this.start = function (timeSlice) {
        audioRecorder = new exports.MediaStreamRecorder(mediaStream);
        videoRecorder = new exports.MediaStreamRecorder(mediaStream);
...
function MediaRecorderWrapper(mediaStream) {
    ...
    this.start = function (mTimeSlice) {
        ...
        function startRecording() {
            ...
            mediaRecorder = new exports.MediaRecorder(mediaStream);
...
exports.StereoAudioRecorder = function(mediaStream) {
    // void start(optional long timeSlice)
    // timestamp to fire "ondataavailable"
    this.start = function (timeSlice) {
...
// ===================
// WhammyRecorder.js
exports.WhammyRecorder = function(mediaStream) {
    // void start(optional long timeSlice)
    // timestamp to fire "ondataavailable"
    this.start = function (timeSlice) {
        timeSlice = timeSlice || 1000;
...
exports.GifRecorder = function(mediaStream) {
...
exports.mediaMaker = function(mediaStream) {
    if (!mediaStream) {
        throw 'MediaStream is mandatory.';
    }
    ...
    this.start = function (timeSlice) {
        ...
        var Recorder = exports.StereoAudioRecorder;
        // video recorder (in WebM format)
        if (this.mimeType.indexOf('video') !== -1) {
            Recorder = IsChrome || IsEdge || IsOpera ? exports.WhammyRecorder : exports.MediaRecorderWrapper;
        }
        
        // video recorder (in GIF format)
        if (this.mimeType === 'image/gif') {
            Recorder = exports.GifRecorder;
        }
